        ...
        <form enctype="multipart/form-data" method="POST" class="form-horizontal">
            <div class="fp-formset">
                <div class="fp-file control-group clearfix">
                    ...
                    <div class="controls">
                        <input type="file" id="fileUpload" style="padding:0;color:transparent;width:95px;height:25px;"/>
                        <p id="fileDetail" style="display:block;float:left;margin:-30px 0 0 100px;background-color:#fff;font-weight:bold;font-size:13px;line-height:130%">
                            Silakan masukkan file *.doc<br/ >ukuran maksimal '.str_replace('M',' MB',ini_get('post_max_size')).'
                        </p>
                    </div>
                </div>
                <div class="fp-saveas control-group clearfix">
